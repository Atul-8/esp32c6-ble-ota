...
## 待办（pending）
- [x] TASK-005 [LAYERING] PR-1: ota_sink 抽象框架 + BLE transport 迁移 + epoch 会话修复 @embedded-firmware-engineer | 2026-09-03: 三次真机回归全过（含 P0-1 断连重试 epoch 实证），smoke 复核 PASS + ERR-014 修复 | 2026-09-03 交付完成，真机回归 A/B/C 全绿（ERR-013 修复后 B 两轮复验绿），待 PM 验收勾销
